...
Docs.getdoc(::Val{NEXT_BUFFER}) = "Push an out-of-band buffer object."
Docs.getdoc(::Val{READONLY_BUFFER}) = "Make an out-of-band buffer object read-only."

Docs.getdoc(::Val{NONE}) = "Push None on the stack."
