@testset "SAVE" begin
  ...
  mktempdir() do path
    @testset "array" begin
      ...
      @test pyconvert(Any, save_arr["x0"].numpy()) ≈ x0
      @test pyconvert(Any, save_arr["x1"].numpy()) ≈ x1
      @test pyconvert(Any, save_arr["x2"].numpy()) ≈ x2
      @test pyconvert(Any, save_arr["x3"].numpy()) ≈ x3
      @test pyconvert(Any, save_arr["x4"].numpy()) ≈ x4
    end
    ...
    @testset "slice" begin
      ...
      @test pyconvert(Any, save_x.numpy()) ≈ x
      @test pyconvert(Any, save_slice.numpy()) ≈ x_slice
    end
    ...
    @testset "stride" begin
      ...
      @test pyconvert(Any, save_x.numpy()) ≈ x
      @test pyconvert(Any, save_stride.numpy()) ≈ x_stride
    end
    ...
    @testset "reshape" begin
      ...
      @test pyconvert(Any, save_x.numpy()) ≈ x
      @test pyconvert(Any, save_reshape.numpy()) ≈ x_reshape
    end
    ...
    @testset "offset" begin
      ...
      @test pyconvert(Any, save_x.numpy()) ≈ x
      @test pyconvert(Any, save_offset.numpy()) ≈ x_offset
    end
    ...
    @testset "mutation" begin
      ...
      save_x2[0] = 0
      x2[1, :] .= 0
      @test pyconvert(Any, (save_x1[5] == 0).all().item())
      @test pyconvert(Any, save_x1.numpy()) ≈ x1
      @test pyconvert(Any, save_x2.numpy()) ≈ x2
    end
    ...
    @testset "transpose" begin
      ...
      @test pyconvert(Any, save_x.numpy()) ≈ x
      @test pyconvert(Any, save_transpose.numpy()) ≈ x_transpose
    end
